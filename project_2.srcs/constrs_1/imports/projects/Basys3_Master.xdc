...
set_property PACKAGE_PIN R2 [get_ports {pb}]					
...
#set_property PACKAGE_PIN W18 [get_ports {buz}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buz}]
#set_property PACKAGE_PIN U15 [get_ports {buz}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {buz}]
set_property PACKAGE_PIN U14 [get_ports {buz}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {buz}]
